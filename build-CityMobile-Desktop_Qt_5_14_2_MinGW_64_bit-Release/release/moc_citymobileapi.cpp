...
#include <memory>
#include "../../CityMobile/citymobileapi.h"
...
QT_MOC_LITERAL(4, 41, 5) // "reply"
    ...
    "CityMobileAPI\0s_finished\0\0QNetworkReply*\0"
    "reply"
};
...
void CityMobileAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->s_finished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CityMobileAPI::*)(QNetworkReply * );
...
// SIGNAL 0
void CityMobileAPI::s_finished(QNetworkReply * _t1)
{
